...
![learnclound-1.png](http://7xi700.com1.z0.glb.clouddn.com/leancloud-1.png-alias)

接着点击左侧菜单中的**存储**，然后在中间的列表中点击**创建Class**，输入名称点击创建即可，如下图所示：
![learnclound-2.png](http://7xi700.com1.z0.glb.clouddn.com/leancloud-2.png-alias)
